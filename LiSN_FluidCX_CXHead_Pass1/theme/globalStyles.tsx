...
// -----------------------------------------------------------------------------
// ONE global style block for the whole dashboard. This is the single home for
// the drill-down slide-in @keyframes (a recurring bug class is defining the
// keyframes per-component, which breaks the animation). Mount this exactly once
// — DashboardThemeProvider does so for you.
// -----------------------------------------------------------------------------
...
/* --- THE drill-down slide-in (defined once, globally) --------------------- */
