...
export default function AddonLayout({
  ...
  const handleTimeFilterChange = (filter: TimeFilter) => setTimeFilter(filter);
            ...
            <div className="flex items-center gap-4">
                ...
                >
                  {timeFilterOptions.map((option) => (
                    <button
                      ...
                      style={{
                        backgroundColor: timeFilter === option.value ? '#5332FF' : 'transparent',
                        color: timeFilter === option.value ? '#FFFFFF' : '#D6D9D8'
                      }}
                    >
              ...
              >
                <div 
                  ...
                  style={{ backgroundColor: isDarkMode ? '#5332FF' : '#D6D9D8' }}
                >
                  <div 
