...
export default function PaingradationLayout({
  ...
  const isExecutiveSummaryActive = pathname === '/ecom/paingradation';
  const isImperfectnessActive = pathname === '/ecom/paingradation/imperfectness';
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      >
        <button
          onClick={() => router.push('/ecom/paingradation')}
        ...
        <button
          onClick={() => router.push('/ecom/paingradation/imperfectness')}
          className="flex-1 flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-200"
          style={{
