          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5 gap-4">
            {socialKPIItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none bg-linear-to-br from-purple-500/5 via-purple-500/0 to-transparent" />
    ...
    <div className="space-y-6 animate-fade-in pb-6">
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as Channel)} className="w-full">
          <TabsList className="h-auto border border-white/10 bg-app-black/60 p-1 shadow-lg">
            <TabsTrigger 
              value="all" 
              className="data-[state=active]:bg-linear-to-r data-[state=active]:from-[#b90abd] data-[state=active]:to-[#5332ff] data-[state=active]:text-white text-muted-foreground hover:text-white"
            >
              {getChannelIcon('all')}
