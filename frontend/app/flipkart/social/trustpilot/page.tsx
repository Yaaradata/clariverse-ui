    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            {/* Average Rating */}
            <Card className="relative overflow-hidden group transition-all duration-300 shadow-lg hover:shadow-2xl border-l-4 border-l-[#b90abd] hover:border-l-[#a009b3] hover:scale-[1.02] hover:-translate-y-1 flex flex-col h-full">
              ...
              <CardContent className="p-6 pt-8 relative z-10 flex flex-col flex-1 min-h-0">
                <div className="flex items-start justify-between mb-4 min-h-10 shrink-0">
                  ...
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#1e293b] text-yellow-400 group-hover:scale-110 transition-transform duration-200">
            ...
            <Card className="relative overflow-hidden group transition-all duration-300 shadow-lg hover:shadow-2xl border-l-4 border-l-[#b90abd] hover:border-l-[#a009b3] hover:scale-[1.02] hover:-translate-y-1 flex flex-col h-full">
              ...
              <CardContent className="p-6 pt-8 relative z-10 flex flex-col flex-1 min-h-0">
                <div className="flex items-start justify-between mb-4 min-h-10 shrink-0">
                  ...
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#1e293b] text-emerald-400 group-hover:scale-110 transition-transform duration-200">
      ...
      <Card className={SOCIAL_CARD_BASE}>
        <CardHeader>
          ...
          <CardDescription className="text-gray-400">
            E-commerce review clusters ranked by volume for uplifting vs detracting Trustpilot narratives
          </CardDescription>
        </CardHeader>
        <CardContent className="pt-2 pb-6">
