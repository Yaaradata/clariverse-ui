        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center gap-2 mt-3">
              ...
              <Link href="/flipkart/email/executive">
                <Button
                  variant="outline"
                  size="sm"
              ...
              <Link href="/flipkart/email/manager">
                <Button
                  variant="outline"
                  size="sm"
                  className="bg-[#b90abd]/10 border-[#b90abd]/30 text-[#b90abd] hover:bg-[#b90abd]/20"
              ...
              <Link href="/flipkart/email/finance">
                <Button
                  variant="outline"
                  size="sm"
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex justify-end">
              <Button
                onClick={openChatbot}
                className="bg-linear-to-r from-[#b90abd] to-[#5332ff] hover:from-[#a009b3] hover:to-[#4a2ae6] text-white shadow-lg hover:shadow-[#b90abd]/30 transition-all duration-200 group h-[38px] px-6"
              >
            ...
            <div className="flex items-center gap-2 justify-end">
              ...
              <Button
                ...
                className="bg-linear-to-r from-[#b90abd] to-[#5332ff] hover:from-[#a009b3] hover:to-[#4a2ae6] text-white shadow-lg hover:shadow-[#b90abd]/30 transition-all duration-200 h-[38px]"
              >
                Apply
                      ...
                      <div className={`grid grid-cols-2 gap-0 border border-gray-600 rounded-lg overflow-hidden ${selectedQuadrant ? 'h-full' : ''}`}>
                        ...
                        return (
                          ...
                          >
                            ...
                            {hasHighPriority && (
                              <div className="absolute inset-0 bg-linear-to-br from-[#b90abd]/10 via-[#b90abd]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-lg" />
                            )}
                            ...
                            {quadrant === 'do' && quadrantThreads.length > 0 && (
                              <Button
                                size="sm"
                                className="w-full mt-2 bg-linear-to-r from-[#b90abd] to-[#5332ff] hover:from-[#a009b3] hover:to-[#4a2ae6] text-white text-xs border-0 shadow-lg hover:shadow-[#b90abd]/30 transition-all duration-200"
                                onClick={(e) => {
                                  e.stopPropagation();
                    ...
                    <CardHeader className="pb-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 min-w-0 flex-1">
                          <Target className="h-5 w-5 text-[#b90abd] shrink-0" />
