...
export const ROLE_DATA = {
  ...
  head_retail: {
    tiles: [
      { title: "Customer Happiness", score: 72, color: T.amber, icon: Target, sub: "HV vs LV Happiness · Top Pain · Churn Risk", insight: "68% of high-value customers are happy — 32% flagged unhappy, mostly on mortgage servicing & fee confusion. Low-value: 81% happy. 3 HNI at 72–89% churn probability. Top driver of unhappiness: EMI failures (31%), fee confusion (24%).", kpis: [{ l: "HV Happy", v: "68%" }, { l: "LV Happy", v: "81%" }, { l: "Top Pain", v: "EMI 31%" }, { l: "Churn Risk", v: "3 HNI" }] },
      { title: "Brand & Reputation Risk", score: 64, color: T.amber, icon: Shield, sub: "Channel Sentiment · Key Insights · Trustpilot", insight: "Overall sentiment 0.58 — below 0.65 target. Best channel: App Store (0.71). Worst: Social/X (0.41) driven by fee complaints. Trustpilot dropped to 3.2 from 3.8. Key this week: 2 new product features surfaced from customer conversations.", kpis: [{ l: "Sentiment", v: "0.58" }, { l: "Trustpilot", v: "3.2 ▼" }, { l: "Best Channel", v: "App 0.71" }, { l: "Key Insights", v: "2 new" }] },
      { title: "Service Fulfilment", score: 68, color: T.gold, icon: Activity, sub: "Best vs Worst SLA · Trend · Bottleneck", insight: "Best: Card Replacement at 91% SLA. Worst: Fee Dispute at 64% — avg 3.2 days vs 1-day target. Overall SLA trending down 6% this week. Root cause: KYC API delays blocking 580 applications and slowing dispute resolution.", kpis: [{ l: "Best SLA", v: "91%" }, { l: "Worst SLA", v: "64%" }, { l: "Trend", v: "▼ −6%" }, { l: "Bottleneck", v: "KYC" }] },
    ],
    lobKpis: [
