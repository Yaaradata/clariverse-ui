...
export const INDUSTRIES = [
  ...
  { id: "credit_cards", name: "Credit Cards", icon: CreditCard, color: "#eab308", desc: "Card portfolio, disputes, fraud, rewards, collections",
    roles: [
      ...
      { id: "head_cards", name: "Head of Credit Cards", icon: CreditCard, sub: "Executive view · portfolio tiles · AI risk spike monitor · day generator" },
...
export const ROLE_DATA = {
  ...
  head_retail: {
    tiles: [
      { title: "Are our Customers happy?", score: 72, color: T.amber, icon: Target, sub: "HV vs LV Happiness · Top Pain · Churn Risk", insight: "32% flagged unhappy, mostly on mortgage servicing & fee confusion. Low-value: 81% happy. 3 HNI at 72–89% churn probability. Top driver of unhappiness: EMI failures (31%), fee confusion (24%).", kpis: [{ l: "HV Happy", v: "68%" }, { l: "LV Happy", v: "81%" }, { l: "Top Pain", v: "EMI 31%" }, { l: "Churn Risk", v: "3 HNI" }] },
      { title: "Is the Brand at risk?", score: 64, color: T.amber, icon: Shield, sub: "Channel Sentiment · Key Insights · Trustpilot", insight: "Below 0.65 target. Best channel: App Store (0.71). Worst: Social/X (0.41) driven by fee complaints. Trustpilot dropped to 3.2 from 3.8. Key this week: 2 new product features surfaced from customer conversations.", kpis: [{ l: "Sentiment", v: "0.58" }, { l: "Trustpilot", v: "3.2 ▼" }, { l: "Best Channel", v: "App 0.71" }, { l: "Key Insights", v: "2 new" }] },
      { title: "How is our Service delivery?", score: 68, color: T.gold, icon: Activity, sub: "Best vs Worst SLA · Trend · Bottleneck", insight: "Best: Card Replacement at 91% SLA. Worst: Fee Dispute at 64% — avg 3.2 days vs 1-day target. Overall SLA trending down 6% this week. Root cause: KYC API delays blocking 580 applications and slowing dispute resolution.", kpis: [{ l: "Best SLA", v: "91%" }, { l: "Worst SLA", v: "64%" }, { l: "Trend", v: "▼ −6%" }, { l: "Bottleneck", v: "KYC" }] },
    ],
    lobKpis: [
