...
export type ViolationCategory = 'Sanctions / PEP Screening' | 'AML Compliance' | 'Customer Identification Program' | 'Regulatory Reporting' | 'GDPR Compliance' | 'Cross-Border Compliance' | 'Vendor Compliance';
...
export const violationCategoryData: Record<TimeFilter, ViolationData[]> = {
  '24h': [
    ...
    { category: 'GDPR Compliance', count: 20, trend: 8, severity: 'medium', percentage: 10 },
  ...
  '7d': [
    ...
    { category: 'GDPR Compliance', count: 145, trend: 6, severity: 'medium', percentage: 10 },
  ...
  '30d': [
    ...
    { category: 'GDPR Compliance', count: 578, trend: 8, severity: 'medium', percentage: 10 },
