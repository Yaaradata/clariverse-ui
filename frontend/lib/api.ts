...
export const BANK_SOCIAL_TOPICS = [
  ...
  'Quick Response Time',
  'Long Wait Times',
  'Multilingual Support Appreciated',
  'Language Barriers Experienced',
  'Problem Resolved Efficiently',
  'Call Disconnection Issues',
  'Knowledgeable Agent Helped',
  'Unhelpful Agent Encountered',
...
export async function getTrustpilotDashboard(filters?: TrustpilotFilters): Promise<TrustpilotDashboardData> {
  ...
  return {
    ...
    clusterVolume: [
      { cluster: 'Payment Operations', positive: 52, negative: 178, neutral: 26 },
      { cluster: 'Digital Channels', positive: 88, negative: 132, neutral: 34 },
      { cluster: 'Customer Support', positive: 96, negative: 165, neutral: 42 },
      { cluster: 'Regulatory & Compliance', positive: 74, negative: 118, neutral: 27 },
      { cluster: 'Cross-Border Services', positive: 81, negative: 143, neutral: 38 },
      { cluster: 'Treasury & Wealth', positive: 109, negative: 56, neutral: 21 },
    ],
    topicBubbles: [
      { topic: 'Payment Processing Failure', volume: 212, sentiment: -0.74, aiSummary: 'High volume of SEPA and card payments failing during peak hours' },
      { topic: 'Mobile App Crashes', volume: 184, sentiment: -0.69, aiSummary: 'Retail customers report repeated crashes on biometric login and transfers' },
      { topic: 'Account Access Problems', volume: 167, sentiment: -0.52, aiSummary: 'Customers locked out during PSD2 step-up authentication requests' },
      { topic: 'Fee Structure Criticism', volume: 141, sentiment: -0.47, aiSummary: 'Complaints about opaque cross-border, FX, and maintenance fees' },
      { topic: 'System Outage Frustration', volume: 129, sentiment: -0.63, aiSummary: 'Planned maintenance windows causing outage frustration across EU markets' },
      { topic: 'Cross Border Issues', volume: 118, sentiment: -0.58, aiSummary: 'Delays and errors reported for SEPA and SWIFT transfers' },
      { topic: 'Regulatory Compliance Questions', volume: 96, sentiment: -0.28, aiSummary: 'Queries about AML/KYC follow-ups and documentation requests' },
      { topic: 'Customer Service Disappointment', volume: 102, sentiment: -0.45, aiSummary: 'Support backlog leading to unresolved complaints and escalations' },
      { topic: 'Digital Innovation Appreciation', volume: 88, sentiment: 0.61, aiSummary: 'Positive feedback on new digital onboarding and budgeting tools' },
      { topic: 'Trade Finance Satisfaction', volume: 76, sentiment: 0.54, aiSummary: 'Corporate clients praise expedited guarantee issuance and advisory' },
      { topic: 'GDPR Compliance Praise', volume: 64, sentiment: 0.48, aiSummary: 'Customers recognise transparent data handling and privacy controls' },
      { topic: 'Excellent Call Support', volume: 71, sentiment: 0.42, aiSummary: 'Shout-outs for multilingual contact centre teams resolving complex cases' },
    ],
    trendData: [
    ...
    aiInsights: [
      {
        id: 'tp-1',
        title: 'Payment Processing Failure mentions up 41% week-over-week',
        description: 'PSD2 strong customer authentication is timing out for high-value transactions in DE/FR markets',
        action: 'Coordinate with payments team, review AISP/PISP callbacks, notify impacted wealth customers proactively',
        severity: 'critical',
        impact: '41% of all negative mentions cite failed SEPA or card payments',
      },
      {
        id: 'tp-2',
        title: 'Mobile App Crashes concentrated on iOS 18 Face ID flow',
        description: 'Crash analytics show spike after 5.12.0 release; sentiment dropped 22 points on Trustpilot',
        action: 'Ship hotfix, roll back biometric module, publish incident update in status page',
        severity: 'high',
        impact: '184 crash-related reviews in last 7 days',
      },
      {
        id: 'tp-3',
        title: 'Digital Innovation Appreciation trending on social media',
        description: 'Customers highlight new carbon-footprint tracker and instant account opening',
        action: 'Amplify in owned channels, brief relationship managers to reference in outreach',
        severity: 'low',
        impact: 'Positive sentiment +18 points across Twitter and Trustpilot',
      },
      {
        id: 'tp-4',
        title: 'Regulatory Compliance Questions rising amongst SME clients',
        description: 'Onboarding documentation requests leading to confusion around beneficial ownership forms',
        action: 'Publish updated checklist, align compliance FAQ across languages, brief frontline teams',
        severity: 'medium',
        impact: '96 reviews referencing compliance clarifications this month',
      },
    ],
    actionFunnel: [
      { topic: 'Payment Processing Failure', urgency: 'critical', resolutionStatus: 'open', resolvedPercent: 18, count: 178 },
      { topic: 'Mobile App Crashes', urgency: 'high', resolutionStatus: 'in_progress', resolvedPercent: 34, count: 145 },
      { topic: 'Account Access Problems', urgency: 'high', resolutionStatus: 'open', resolvedPercent: 22, count: 132 },
      { topic: 'Regulatory Compliance Questions', urgency: 'medium', resolutionStatus: 'in_progress', resolvedPercent: 41, count: 96 },
      { topic: 'Cross Border Issues', urgency: 'high', resolutionStatus: 'in_progress', resolvedPercent: 28, count: 118 },
      { topic: 'Trade Finance Satisfaction', urgency: 'low', resolutionStatus: 'resolved', resolvedPercent: 86, count: 76 },
    ],
    clusters: [
      'Payment Processing Failure',
      'Mobile App Crashes',
