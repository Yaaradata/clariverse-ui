...
export function InsightCard({
  ...
  return (
    <Tag
      ...
      onClick={onOpen}
      className={variant === "hero" ? "lisn-cat-anim-scale" : undefined}
      style={{
        ...
        padding: variant === "hero" ? "18px 20px" : "14px 16px",
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", gap: 8, alignItems: "flex-start" }}>
        <span style={{ fontSize: variant === "hero" ? 18 : 14, fontWeight: 700, color: cssVar("text-primary"), lineHeight: 1.3 }}>
          {signal.title}
        </span>
        <span
          style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", gap: 8, fontSize: 11 }}>
        ...
        <span className="lisn-cat-num" style={{ color: cssVar("accent"), fontWeight: 600 }}>
          {signal.impactRupee}
        </span>
      </div>
