  ...
  return (
    <DashboardThemeProvider value={theme ?? FALLBACK_THEME}>
      <div className="min-h-screen bg-[#070707] text-white">
        <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_top_left,rgba(20,184,166,0.14),transparent_32%),radial-gradient(circle_at_top_right,rgba(99,102,241,0.10),transparent_34%)]" />

        <header
          className="sticky top-0 z-30 border-b bg-[#070707]/95 backdrop-blur"
          style={{ borderColor: C.border }}
        >
          <div className="mx-auto flex max-w-[1920px] flex-col gap-3 px-4 py-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    {tab === "coverage"
                      ? "RBI Obligation Coverage Dashboard"
                      : "Outbound Conduct & Location Intelligence"}
                  </h1>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="hidden items-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-1.5 md:flex">
                ...
                <span className="text-[10px] font-black uppercase text-zinc-400">
                  {fmt(REGISTER_STATS.contactsAnalysed)} interactions · 100% voice
                </span>
              </div>
              <div className="hidden items-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-1.5 md:flex">
              ...
              <div className="flex flex-wrap gap-1 rounded-xl border border-white/10 bg-white/[0.04] p-1">
                {(Object.keys(EXECUTIVE_LENSES) as ExecutiveLens[]).map((id) => (
                  <button
                    key={id}
                    type="button"
                    onClick={() => setLens(id)}
          ...
          <div className="mx-auto max-w-[1920px] px-4 pb-3">
            <div
                ...
                return (
                  ...
                  >
                    <span
                      ...
                      style={{
                        background: active ? `${C.teal}22` : "rgba(255,255,255,0.04)",
        ...
        <main className="mx-auto max-w-[1920px] px-4 py-5">
