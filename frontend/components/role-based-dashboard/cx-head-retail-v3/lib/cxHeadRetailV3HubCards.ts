...
export const HUB_PAGE_PURPOSE: Record<HubCardId, string> = {
  ...
  "brand-risk":
    "Public reach, channel sentiment, and competitor buzz ranked by corroboration — each signal carries named action.",
  "service-delivery":
...
export const HUB_JOURNEY_CARDS: HubJourneyCardData[] = [
  ...
  {
    id: "brand-risk",
    title: "Is our brand at risk?",
    subtitle: "Channel Sentiment · Key Insights · Store Ratings",
    ...
    timeline: [
      {
        ...
        rightPanel: {
          ...
          channels: [
            ...
            { name: "Live Chat", v: 0.63 },
            { name: "Email", v: 0.62 },
            { name: "Reviews", v: 0.6 },
            { name: "Social/X", v: 0.55 },
          ],
        },
        conversationInsight:
          "Above 0.65 sentiment target at week open. App Store\nleads all channels at 0.71 — strongest public signal.\nSocial/X noisy at 0.55 but contained to platform.\nNo viral themes crossing into news cycle yet today.",
      },
      {
        label: "D2",
        heroValue: 62,
        rightPanel: {
          kind: "channels",
          channels: [
            { name: "App Store", v: 0.7 },
            { name: "Live Chat", v: 0.58 },
            { name: "Email", v: 0.59 },
            { name: "Reviews", v: 0.57 },
            { name: "Social/X", v: 0.46 },
          ],
        },
        conversationInsight:
          "Cross-channel sentiment dip as delivery complaints\nland on Reviews and Social/X simultaneously.\n#NeverDelivered mentions forming — watch Social reach.\nApp Store holds flat; Trustpilot softening to 3.6.",
      },
      {
        label: "D3",
        heroValue: 68,
        rightPanel: {
          kind: "channels",
          channels: [
            { name: "App Store", v: 0.72 },
            { name: "Live Chat", v: 0.56 },
            { name: "Email", v: 0.58 },
            { name: "Reviews", v: 0.55 },
            { name: "Social/X", v: 0.42 },
          ],
        },
        conversationInsight:
          "PR response lifts mid-week sentiment on App Store\nand Live Chat after status-page acknowledgement.\nReviews still lag on delivery delay story threads.\nSocial/X at 0.42 — late-delivery posts accelerating.",
      },
      {
        label: "D4",
        heroValue: 59,
        rightPanel: {
          kind: "channels",
          channels: [
            { name: "App Store", v: 0.73 },
            { name: "Live Chat", v: 0.54 },
            { name: "Email", v: 0.57 },
            { name: "Reviews", v: 0.53 },
            { name: "Social/X", v: 0.38 },
          ],
        },
        conversationInsight:
          "Viral late-delivery thread hits Social/X — sentiment\ndrops to 0.38, lowest channel this week. Trustpilot\nslips to 3.4 stars from shopper photo evidence posts.\nFee complaints rising on Reviews — fee fix pending.",
      },
      {
        label: "D5",
        heroValue: 63,
        rightPanel: {
          ...
          channels: [
            { name: "App Store", v: 0.73 },
            { name: "Live Chat", v: 0.53 },
            { name: "Email", v: 0.565 },
            { name: "Reviews", v: 0.535 },
            { name: "Social/X", v: 0.37 },
          ],
        },
        conversationInsight:
          "Stabilising after status-page push and courier comms\nsent to affected pin codes. Social/X still at 0.37.\nHidden platform fee complaints need in-app pricing fix.\nApp Store holding at 0.73 — only bright channel now.",
      },
      {
        label: "D6",
        heroValue: 64,
        rightPanel: {
          kind: "channels",
          channels: [
            { name: "App Store", v: 0.74 },
            { name: "Live Chat", v: 0.52 },
            { name: "Email", v: 0.56 },
            { name: "Reviews", v: 0.54 },
            { name: "Social/X", v: 0.36 },
          ],
        },
        brand: {
          severity: "Critical",
          topTheme: "#NeverDelivered viral",
          competitor: "Amazon sale comparisons up",
          trustSignal: "340 nobody-acted complaints",
          fraudSignal: "Refund fraud rising",
          spread: "Social + Reviews · Going public",
        },
        conversationInsight:
          "Below 0.65 target · sentiment still fragile.\nApp Store best 0.74 · Social/X worst 0.36.\n#NeverDelivered viral · Trustpilot down to 3.2.\nRoute social crisis — 3,650 X mentions today.",
      },
    ],
