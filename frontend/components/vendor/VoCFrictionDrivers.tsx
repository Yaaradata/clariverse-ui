...
// Category colors - matching RedFlagDistributionChart
...
interface VoCFrictionDriversProps {
  phrases: ComplaintPhrase[];
  isDarkMode?: boolean;
}

export function VoCFrictionDrivers({ phrases, isDarkMode = false }: VoCFrictionDriversProps) {
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-2 mb-1">
                            <span 
                              ...
                              style={{ 
                                backgroundColor: (CATEGORY_COLORS[phrase.category] || '#888888') + '20',
                                color: CATEGORY_COLORS[phrase.category] || '#888888',
                                borderWidth: '1px',
                                borderStyle: 'solid',
                                borderColor: (CATEGORY_COLORS[phrase.category] || '#888888') + '40'
                              }}
                            >
                              {phrase.category}
                            </span>
