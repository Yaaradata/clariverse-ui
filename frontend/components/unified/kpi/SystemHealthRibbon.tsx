            ...
            <Tooltip key={metric.channel}>
              <TooltipTrigger asChild>
                <Card
                  ...
                  className="border-(--border) bg-(--card) p-6 transition-all duration-200 hover:bg-(--background) hover:border-[#b90abd]/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#b90abd]"
                >
              ...
              <TooltipContent className="max-w-xs bg-[--background] text-sm text-gray-100">
                <div className="space-y-1">
